...
$name = $property['Student']['name'];
$last_name = $property['Student']['last_name'];

$courses = '<h2>Cursos del alumno</h2>';
...
$filename = 'Estudiante_'.$property['Student']['name'].'_'.$date.'.pdf';
